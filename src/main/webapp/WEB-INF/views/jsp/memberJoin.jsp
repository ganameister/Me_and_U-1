				...
				<form>		<%-- 회원가입 폼 시작 --%>
					...
					<table id="joinMemberTable">		<!-- 회원가입정보 입력 테이블 시작 -->
						...
						<tr><td class="insertTxt"><input type="text" placeholder="아이디 입력" id="insertMemID" name="insertMemID" class="insertMemInfo">
												  <input type="button" value="중복확인" id="idCheck"></td></tr>
						<tr><th>비밀번호</th></tr>
						...
						<tr><th>성별</th></tr>
						<tr><td class="insertTxt"><input type="radio" name="gender" value="남" checked>남<input type="radio" name="gender" value="여">여</td></tr>
						<tr><th>주소지</th></tr>
						<tr><th>우편번호</th></tr>
						<tr><td><input type="text" placeholder="우편번호 검색" id="sample6_postcode" class="insertMemInfo">
								<input type="button" onclick="sample6_execDaumPostcode()" value="우편번호 찾기" id="addressSrchBtn"></td></tr>
						<tr><td><input type="text" placeholder="도로명 주소" id="sample6_address" class="insertMemInfo"></td></tr>
						...
						<tr><th>관심분야2</th></tr>
						<tr><th class="insertTxt"><input type="text" value="상세 관심분야 입력" class="insertMemInfo"></th></tr>
					</table>									<!-- 회원가입정보 입력 테이블 끝 -->
					
					
					<table border="1" id="consentTable">		<!-- 이용약관/개인정보 수집 동의 테이블 시작 -->
						<tr><th colspan="5"><h3>이용약관 / 개인정보 수집 및 이용 동의</h3></th></tr>
						<tr><th>이용약관 동의</th><td><input type="radio" name="ToS"></td><td class="agreeCheck">동의</td>
							<td><input type="radio" name="ToS"></td><td class="agreeCheck">비동의</td></tr>
						<tr><th>개인정보수집 동의</th><td><input type="radio" name="CoPI"></td><td class="agreeCheck">동의</td>
							<td><input type="radio" name="CoPI"></td><td class="agreeCheck">비동의</td></tr>
						<tr><th>메일 수신</th><td><input type="radio" name="ReceiveMail"></td><td class="agreeCheck">동의</td>
							<td><input type="radio" name="ReceiveMail"></td><td class="agreeCheck">비동의</td></tr>
