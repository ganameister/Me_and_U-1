...
<html>
	<head>
		<meta charset="UTF-8">
		<title>비밀번호 찾기</title>
		<link rel="stylesheet" type="text/css" href="<c:url value='/css/memManagement/idnetification.css' />">
		<c:import url="/WEB-INF/views/layout/head.jsp"/>
		<script src="<c:url value='/js/member/identification.js' />"></script>
	</head>
	<body>
		<div id="wrap">
				...
				<form id="frm" name="frm">
					<div id="content">
						<div class="find_inner">
							...
							<button type="submit" class="next_btn"><span id="nextText">다음</span></button>
